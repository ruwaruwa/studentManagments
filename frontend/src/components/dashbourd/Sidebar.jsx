...
<i onClick={handleIsOpen}  style={{display:isOpen === true ?"none" : "block"}}  class="fa-solid fa-xmark text-white text-4xl absolute right-2 mr-2 mt- p-1 sm:none " ></i>
<i onClick={handleClose}  style={{display:isOpen === true ?"block" : "none"}} class="fa-solid fa-bars  text-white  absolute right-5 mr-4 text-3xl mb-[40px] mt-3  sm:none"></i>
